...
// Use a working email service - Ethereal (test service)
...
app.get('/api/health', (req, res) => {
  res.json({ status: 'OK', message: 'Final working server is running' });
});
...
app.listen(PORT, () => {
  ...
  console.log(`\n💡 Using Ethereal test email service - this WILL work!`);
  console.log(`💡 Check console for email preview URLs`);
});
